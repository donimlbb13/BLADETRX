        ...
        if ($user->exist() == false) {
            ...
            try {
                ...
                elseif (!is_numeric($out_amount) || $out_amount < InvestmentPlan::getValueByName("minimum_payout")) {
                    ...
                    $this->replyWithMessage([
                        'text' => "You need to payout at least " . InvestmentPlan::getValueByName("minimum_payout") . " TRX. Also the amount need to be numeric.",
                        'reply_markup' => $reply_markup,
                        'parse_mode' => 'HTML',
                    ]);
                }
                 ...
                 */
                     ...
                     */T(InvestmentPlan::TRX('withdraw_fee')) <= 0) {

                        /**
                         * Response
                         */
                        $this->replyWithMessage([
                            'text' => "The minimum withdraw amount is " . TRX::Format((TRX::TRX(InvestmentPlan::getValueByName('withdraw_fee')) + 10 TRX)) . "TRX. This will give you a refund of 100 TRX. This is because of the withdraw fee of " . TRX::Format(TRX::TRX(InvestmentPlan::getValueByName('withdraw_fee'))) . " TRX.",
                            'reply_markup' => $reply_markup,
                            'parse_mode' => 'HTML',
                        ]);
                        ...
                        $transaction = Wallet::makeOutgoingPayment($user->getWalletAddress(), TRX::TRX($out_amount));
                        ...
                        if (!empty($transaction) && empty($transaction->error)) {
                             ...
                             */
                            $this->replyWithMessage([
                                'text' => "An error occurred while withdrawing your TRX.\n<b>[Error] " . $transaction->error . "</b>. \xF0\x9F\x98\x96",
                                'reply_markup' => $reply_markup,
                                'parse_mode' => 'HTML',
                            ]);
                        }
