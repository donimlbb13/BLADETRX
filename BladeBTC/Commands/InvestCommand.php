			...
			if (isset($payment_address->address)) {
			    ...
			    try{
                    ...
                    $this->replyWithMessage([
                        'text'         => "Here is your personal TRX address for your investments:",
                    ...
                    $this->replyWithMessage([
                        'text'         => "You may invest at anytime and as much as you want (minimum " . InvestmentPlan::getValueByName("minimum_invest") . " TRX). After correct transfer, your funds will be added to your account during an hour. Have fun and enjoy your daily profit!",
                        'reply_markup' => $reply_markup,
                        'parse_mode'   => 'HTML'
                    ]);
                }
